...
Most of the textures in RSS-Origin RSSTexture%TopoRevamp are from SpaceEngine's DLCs, allowed to use and modify under the license of SpaceEngine Pro. Some of it credit to [Astra-Planetshine@www.deviantart.com](https://www.deviantart.com/astra-planetshine), allowed to use and modify under Astra-Planetshine's personal license. Jupiter's color and normal map is derived from RSS-Reborn, used with permission of [@ballisticfox](https://github.com/ballisticfox).
